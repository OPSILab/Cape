...
export class LoginComponent implements AfterViewInit {
  ...
  constructor(private authService: NbAuthService, private configService: NgxConfigureService, private route: ActivatedRoute) {
  ...
  public login = (): void => {
    ...
    this.popupCenter({
      url: `${this.environment.onlineServicesUrl}/login/loginPopup?${queryString}`,
      title: 'AuthPopup',
      w: 780,
      h: 650,
    });
