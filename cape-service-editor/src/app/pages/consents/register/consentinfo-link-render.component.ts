    ...
    this.modalService.open(ConsentInfoModalComponent, {
      context: {
        ...
        concepts: this.getConcepts(
          this.renderValue.viewInfo.payload.common_part.rs_description.resource_set.datasets[
            this.renderValue.viewInfo.payload.common_part.rs_description.resource_set.datasets.length - 1
          ].dataMappings
        ),
